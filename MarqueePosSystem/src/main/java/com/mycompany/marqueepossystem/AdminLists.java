...
public class AdminLists extends javax.swing.JFrame {
    ...
    private void loadAdminData() {
        ...
        model.setRowCount(0);
        for (int i = 0; i < Login.adminIds.size(); i++) {
            Object[] rowData = {
                Login.adminIds.get(i),
                Login.adminUsernames.get(i),
                Login.adminFirstNames.get(i),
                Login.adminLastNames.get(i),
                Login.adminGenders.get(i)
            };
